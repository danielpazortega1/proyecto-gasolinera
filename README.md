...
Sitio web profesional desarrollado para una empresa proveedora de suministros, mantenimiento y equipamiento para estaciones de servicio (gasolineras).

El objetivo principal de este proyecto es tener una **alta visibilidad web** y canalizar a los clientes potenciales directamente a una venta rápida mediante integración con WhatsApp.
...
* **CSS3 Moderno:**
    * Uso de Variables CSS (`:root`) para fácil personalización de colores.
    * **Flexbox & CSS Grid:** Para maquetación adaptable.
    * **Media Queries:** Diseño 100% Responsivo (Mobile-First).
